SELECT
    m.Yang, n.objid, s.specobjid, n.distance, o.ra AS ra, o.dec AS dec,
    ...
    o.score as score
into mydb.output from MyDB.groups_deCarvalho2017 AS m
    CROSS APPLY dbo.fGetNearbyObjAllEq( m.RA, m.DEC, 2*60*m.thetaR200) AS n
